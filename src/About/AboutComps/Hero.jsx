...
const Hero = () => {
  return (
        <div
            className=" z-0 w-full flex  justify-start items-center bg-zinc-900 h-1/2 md:h-[90vh] 
          "
            style={{
              backgroundImage: `url()`, // Wrap the Blob URL with url()
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            <span className="absolute z-10 w-full md:h-full h-1/2 bg-gradient-to-b from-[#ef572a] to-[#972003] 0 "></span>
